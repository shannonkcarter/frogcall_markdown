...
Creating effective data visuals is key for communicating your science clearly and getting attention for your work. Here, I walk through the process of making one of the main figure for my paper in [Ecology Letters](https://shannonkcarter.weebly.com/uploads/1/2/2/1/122153528/cartersaenzrudolf_ele2018.pdf). I'm very proud of this paper! It got accepted to the top jounal in my field, a distinction I largely attribute to the effort and thought that went into these figures.
...
## A custom ggtheme elevates your figure by breaking from commonplace defaults, cleaning the design, and giving an overall aesthetically pleasing look. This theme removes cluttering gridlines and background panels, and gives clean fonts in easily legible sizes.
...
all <- ggplot(daily_calls, aes(x = doy, y = dailysum, color = sp)) + 
  geom_point() + mytheme +
  facet_wrap(~ year)
all
...
overlapplot <- function(s1, s2, y, p) {
  ...
  p <- ggplot(l, aes(x = day, y = s1)) + mytheme +
    ...
    labs(x = "day of year", y = "number of calling frogs")
